...
function load_post() {
  ...
  //in kết quả
  alert(
    "load-post " + city + " " + district + " " + type_room + " " + minprice + " " + maxprice
  );
  testExprisedPost();
  // load bài đăng
  $.ajax({
    ...
    success: function (result) {
      ...
      $.each(result, function (key, item) {
        ...
        postHtml += `<div class="d-flex baidang">
                        <!-- ảnh -->
                        <div class="img-div">
      ...
      $.ajax({
        ...
        success: function (result) {
          ...
          $.ajax({
            ...
            success: function (result) {
              var district =
                '<option value="Quân(Huyện)" hidden>Quận/Huyện</option>';
              $.each(result, function (key, item) {
                district +=
                  '<option value="' +
                  item.prefix +
