...
$(document).ready(function () {
  ...
  $("#tinh_thanh_pho").change(function () {
    if (
      $("#tinh_thanh_pho").hasClass("_focus") &&
      $("#tinh_thanh_pho").val() != "Chưa chọn"
    ) {
  ...
  $("#quan_huyen").change(function () {
    if (
      $("#quan_huyen").hasClass("_focus") &&
      $("#quan_huyen").val() != "Chưa chọn"
    ) {
  ...
  $("#loai_phong").change(function () {
    if (
      $("#loai_phong").hasClass("_focus") &&
      $("#loai_phong").val() != "Chưa chọn"
    ) {
  ...
  $("#month_quarter_year").change(function () {
    if (
      $("#month_quarter_year").hasClass("_focus") &&
      $("#month_quarter_year").val() != "Chưa chọn"
    ) {
  ...
  $("#bathroom").change(function () {
    if (
      $("#bathroom").hasClass("_focus") &&
      $("#bathroom").val() != "Chưa chọn"
    ) {
  ...
  $("#kitchen").change(function () {
    if (
      $("#kitchen").hasClass("_focus") &&
      $("#kitchen").val() != "Chưa chọn"
    ) {
